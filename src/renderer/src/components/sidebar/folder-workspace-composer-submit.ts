...
import { resolveFolderWorkspaceAgentCommandOverrides } from './folder-workspace-agent-command-overrides'
import { preflightFolderWorkspaceAgentTrust } from './folder-workspace-agent-trust'
...
export async function submitFolderWorkspaceCreate({
  ...
  const effectiveCmdOverrides = resolveFolderWorkspaceAgentCommandOverrides({
    agent: quickAgent,
