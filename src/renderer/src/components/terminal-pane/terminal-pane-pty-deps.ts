...
import { createTerminalPaneRateLimitAutoSwitchHandler } from './terminal-pane-rate-limit-auto-switch'
...
export function createTerminalPanePtyDeps(args: {
  ...
  return {
    ...
    onAgentRateLimitDetected:
      ...
      createTerminalPaneRateLimitAutoSwitchHandler({
        worktreeId: deps.worktreeId,
        paneTransportsRef: deps.paneTransportsRef,
        autoSwitchingPaneKeysRef: refs.autoSwitchingPaneKeysRef
      }),
